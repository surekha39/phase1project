	...
	public static void handleWelcomeScreenInput() {
		...
		do {
			try {
				...
				switch (input) {
				case 1:
					FileOperations.displayAllFiles("MainMenu");
					break;
				case 2:
	...
	public static void handleFileMenuOptions() {
		...
		do {
			try {
				...
				FileOperations.createMainFolderIfNotPresent("MainMenu");
				...
				case 3:
					...
					FileOperations.createMainFolderIfNotPresent("MainMenu");
					FileOperations.displayFileLocations(fileName, "MainMenu");
